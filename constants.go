...
const (
	...
	// AccountsMECTIndex is the Elasticsearch index for the accounts with MECT balance
	AccountsMECTIndex = "accountsmect"
	// AccountsMECTHistoryIndex is the Elasticsearch index for the accounts history information with MECT balance
	AccountsMECTHistoryIndex = "accountsmecthistory"
	...
	// TokensIndex is the Elasticsearch index for the MECT tokens
	TokensIndex = "tokens"
	...
	// AccountsMECTPolicy is the Elasticsearch policy for the accounts with MECT balance
	AccountsMECTPolicy = "accountsmect_policy"
	// AccountsMECTHistoryPolicy is the Elasticsearch policy for the accounts history information with MECT
	AccountsMECTHistoryPolicy = "accountsmecthistory_policy"
