...
func TestAddToAlteredAddresses(t *testing.T) {
	...
	tx := &data.Transaction{
		Sender:   sender,
		Receiver: receiver,
		Data:     []byte("MECTTransfer@31323334352d373066366534@174876e800"),
	}
...
func TestTxsDatabaseProcessor_PrepareTransactionsForDatabaseMECTNFTTransfer(t *testing.T) {
	t.Parallel()
	...
	tx1 := &transaction.Transaction{
		GasLimit: 100,
		GasPrice: 123456,
		Data:     []byte("MECTNFTTransfer@595959453643392D303837363661@01@01@000000000000000005005C83E0C42EDCE394F40B24D29D298B0249C41F028974@66756E64@890479AFC610F4BEBC087D3ADA3F7C2775C736BBA91F41FD3D65092AA482D8B0@1c20"),
	}
	scResHash1 := []byte("scResHash1")
	scRes1 := &smartContractResult.SmartContractResult{
		Nonce:          1,
...
func TestTxsDatabaseProcessor_IssueMECTTx(t *testing.T) {
	t.Parallel()
	...
	pool := &indexer.Pool{
		Txs: map[string]coreData.TransactionHandler{
			"t1": &transaction.Transaction{
				SndAddr: decodeBech32("moa1dglncxk6sl9a3xumj78n6z2xux4ghp5c92cstv5zsn56tjgtdwpsk46qrs"),
				RcvAddr: decodeBech32("moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzllls8a5w6u"),
		...
		Scrs: map[string]coreData.TransactionHandler{
			"scr1": &smartContractResult.SmartContractResult{
				...
				Data:           []byte("MECTTransfer@414141414141412d323436626461@0186a0"),
				SndAddr:        decodeBech32("moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzllls8a5w6u"),
				RcvAddr:        decodeBech32("moa1dglncxk6sl9a3xumj78n6z2xux4ghp5c92cstv5zsn56tjgtdwpsk46qrs"),
			},
			"scr2": &smartContractResult.SmartContractResult{
				OriginalTxHash: []byte("t1"),
				Data:           []byte("@6f6b"),
	...
	_, ok := res.AlteredAccts.Get("moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzllls8a5w6u")
	require.True(t, ok)
