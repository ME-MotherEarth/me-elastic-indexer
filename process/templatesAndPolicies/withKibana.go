...
import (
	...
	"github.com/ME-MotherEarth/me-elastic-indexer/templates/withKibana"
)
...
func getTemplatesKibana() map[string]*bytes.Buffer {
	...
	indexTemplates[indexer.AccountsMECTIndex] = withKibana.AccountsMECT.ToBuffer()
	indexTemplates[indexer.AccountsMECTHistoryIndex] = withKibana.AccountsMECTHistory.ToBuffer()
...
func getPolicies() map[string]*bytes.Buffer {
	...
	indexesPolicies[indexer.AccountsMECTPolicy] = withKibana.AccountsMECTPolicy.ToBuffer()
	indexesPolicies[indexer.AccountsMECTHistoryPolicy] = withKibana.AccountsMECTHistoryPolicy.ToBuffer()
	indexesPolicies[indexer.AccountsHistoryPolicy] = withKibana.AccountsHistoryPolicy.ToBuffer()
