...
type ElasticProcessorStub struct {
	...
	RemoveAccountsMECTCalled         func(headerTimestamp uint64) error
}

// RemoveAccountsMECT -
func (eim *ElasticProcessorStub) RemoveAccountsMECT(headerTimestamp uint64) error {
	if eim.RemoveAccountsMECTCalled != nil {
		return eim.RemoveAccountsMECTCalled(headerTimestamp)
	}
