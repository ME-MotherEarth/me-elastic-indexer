...
func TestRelayedTransactionGasUsedCrossShard(t *testing.T) {
	...
	initialTx := &transaction.Transaction{
		Nonce:    1196667,
		SndAddr:  []byte("moa1k7j6ewjsla4zsgv8v6f6fe3dvrkgv3d0d9jerczw45hzedhyed8sh2u34u"),
		RcvAddr:  []byte("moa14eyayfrvlrhzfrwg5zwleua25mkzgncggn35nvc6xhv5yxwml2es0f3dht"),
		GasLimit: 16610000,
		GasPrice: 1000000000,
	...
	scr1 := &smartContractResult.SmartContractResult{
		...
		GasPrice:       1000000000,
		GasLimit:       14732500,
		SndAddr:        []byte("moa14eyayfrvlrhzfrwg5zwleua25mkzgncggn35nvc6xhv5yxwml2es0f3dht"),
		RcvAddr:        []byte("moa1qqqqqqqqqqqqqpgq3dswlnnlkfd3gqrcv3dhzgnvh8ryf27g5rfsecnn2s"),
	...
	poolDstShard := &indexer.Pool{
		Scrs: map[string]coreData.TransactionHandler{
			...
			string(scrWithRefund): &smartContractResult.SmartContractResult{
				Nonce:          3,
				SndAddr:        []byte("moa1qqqqqqqqqqqqqpgq3dswlnnlkfd3gqrcv3dhzgnvh8ryf27g5rfsecnn2s"),
				RcvAddr:        []byte("moa1k7j6ewjsla4zsgv8v6f6fe3dvrkgv3d0d9jerczw45hzedhyed8sh2u34u"),
