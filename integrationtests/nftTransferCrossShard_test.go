...
func TestNFTTransferCrossShardWithSCCall(t *testing.T) {
	...
	scr1 := &smartContractResult.SmartContractResult{
		...
		GasPrice:       1000000000,
		GasLimit:       148957500,
		SndAddr:        []byte("moa1ef9xx3k3m89azf4c4xc98wpcdnx5h0cnxy6em47r6dc4alud0uwqx24f50"),
		RcvAddr:        []byte("moa1qqqqqqqqqqqqqpgq78y09lw93f3udvsplshdv2vk957l5vl70n4splrad2"),
		Data:           []byte("MECTNFTTransfer@4c4b4641524d2d336634663962@016534@6f1e6f01bc7627f5ae@@636f6d706f756e645265776172647350726f7879@000000000000000005004f79ec44bb13372b5ac9d996d749120f476427627ceb"),
		PrevTxHash:     txHash,
	...
	pool := &indexer.Pool{
		Txs: map[string]coreData.TransactionHandler{
			string(txHash): &transaction.Transaction{
				Nonce:    79,
				SndAddr:  []byte("moa1ef9xx3k3m89azf4c4xc98wpcdnx5h0cnxy6em47r6dc4alud0uwqx24f50"),
				RcvAddr:  []byte("moa1ef9xx3k3m89azf4c4xc98wpcdnx5h0cnxy6em47r6dc4alud0uwqx24f50"),
				GasLimit: 150000000,
				GasPrice: 1000000000,
				Data:     []byte("MECTNFTTransfer@4c4b4641524d2d336634663962@016534@6f1e6f01bc7627f5ae@00000000000000000500f1c8f2fdc58a63c6b201fc2ed629962d3dfa33fe7ceb@636f6d706f756e645265776172647350726f7879@000000000000000005004f79ec44bb13372b5ac9d996d749120f476427627ceb"),
				Value:    big.NewInt(0),
			},
		},
	...
	poolDstShard := &indexer.Pool{
		Scrs: map[string]coreData.TransactionHandler{
			...
			string(scrWithRefund): &smartContractResult.SmartContractResult{
				SndAddr:        []byte("moa1qqqqqqqqqqqqqpgq57szwud2quysucrlq2e97ntdysdl7v4ejz3qn3njq4"),
				RcvAddr:        []byte("moa1ef9xx3k3m89azf4c4xc98wpcdnx5h0cnxy6em47r6dc4alud0uwqx24f50"),
...
func TestNFTTransferCrossShard(t *testing.T) {
	...
	scr2 := &smartContractResult.SmartContractResult{
		...
		Data:           []byte("MECTNFTTransfer@434f4c45435449452d323663313838@01@01@"),
		PrevTxHash:     txHash,
		OriginalTxHash: txHash,
	}
	...
	pool := &indexer.Pool{
		Txs: map[string]coreData.TransactionHandler{
			string(txHash): &transaction.Transaction{
				...
				GasLimit: 5000000,
				GasPrice: 1000000000,
				Data:     []byte("MECTNFTTransfer@536f6d657468696e672d616263646566@01@01@00000000000000000500a7a02771aa07090e607f02b25f4d6d241bff32b990a2"),
				Value:    big.NewInt(0),
			},
		},
		Scrs: map[string]coreData.TransactionHandler{
...
func TestNFTTransferCrossShardImportDBScenarioFirstIndexDestinationAfterSource(t *testing.T) {
	...
	scr2 := &smartContractResult.SmartContractResult{
		...
		SndAddr:        []byte("moa1ure7ea247clj6yqjg80unz6xzjhlj2zwm4gtg6sudcmtsd2cw3xs74hasv"),
		RcvAddr:        []byte("moa1qqqqqqqqqqqqqpgq57szwud2quysucrlq2e97ntdysdl7v4ejz3qn3njq4"),
		Data:           []byte("MECTNFTTransfer@434f4c4c454354494f4e2d323663313838@01@01@"),
		PrevTxHash:     txHash,
		OriginalTxHash: txHash,
	}
	...
	pool := &indexer.Pool{
		Txs: map[string]coreData.TransactionHandler{
			string(txHash): &transaction.Transaction{
				...
				GasLimit: 5000000,
				GasPrice: 1000000000,
				Data:     []byte("MECTNFTTransfer@434f4c4c454354494f4e2d323663313838@01@01@00000000000000000500a7a02771aa07090e607f02b25f4d6d241bff32b990a2"),
				Value:    big.NewInt(0),
			},
		},
		Scrs: map[string]coreData.TransactionHandler{
